...
// console.log(
//   `shipping to ${customer.address.street} ${customer.address.city} ${customer.address.state} ${customer.address.zip}`
// );
...
while(hero1.health > 0 && villain1.health > 0) {
    ...
    const healthAttack = hero1.attack()

    hero1.health = hero1.health - villainMagic
    villain1.health = villain1.health - healthAttack
